<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('create_penjualan'); ?>" method="post">
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_tsk" class="form-control" value="<?php echo $id_transaksi; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">*Nama Pembeli</label>
                                    <input type="text" name="nm_pbl" class="form-control" placeholder="Nama Pembeli" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" name="item_brg" required onchange="getHargaBarang(this)">
                                        <option value=""></option>
                                        <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_beli" class="form-control" placeholder="dd/mm/yy" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="hrg_brg" id="harga_barang" class="form-control" placeholder="Harga Barang" onkeyup="formatAndDisplayRupiah()" autocomplete="off" readonly>
